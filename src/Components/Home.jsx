    ...
    <div className="container my-5">
      <div className="row align-items-center">
        <div className="col-lg-7 text-center text-lg-start">
          ...
          <img
            src="https://thumbs.dreamstime.com/b/welcome-banner-colorful-serpentine-welcome-banner-spruce-branches-colorful-paper-serpentine-vector-illustration-103884659.jpg"
            className="img-fluid"
